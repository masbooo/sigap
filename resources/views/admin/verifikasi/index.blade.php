    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Proses Verifikasi</h4>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <div>
                    <h5 class="fw-semibold mb-1"><b>ANTREAN PROSES VERIFIKASI</b></h5>
                    <p class="text-muted mb-0">
                        @if (($roleContext['scope_type'] ?? 'all') === 'all')
                            Data ini memuat seluruh permohonan reservasi yang akan diverifikasi
                        @else
            ...
            <div class="datatables">
                <div>
                    <table
                        ...
                        data-scroll-x="auto"
                        data-empty-message="Tidak ada data yang tersedia dalam tabel Verifikasi"
                    >
                        ...
                        <tbody>
                            @foreach ($normalizeReservations as $index => $reservation)
                                @php
                                    $statusKey = strtoupper((string) ($reservation['status'] ?? 'VERIFIKASI'));
                                        ...
                                        <div class="admin-table-action-dropdown">
                                            ...
                                            <div class="admin-table-action-menu" hidden>
                                                ...
                                                <form
                                                    ...
                                                    data-approve-title="MENUNGGU PEMBAYARAN"
                                                    data-approve-text="Pengajuan verifikasi <b class='text-danger'>{{ $requestCode }}</b> telah sesuai<br><br>Lanjut ke Pembayaran?"
                                                ...
                                                <form
                                                    ...
                                                    data-reservation-label="{{ $requestCode }}"
                                                    data-reject-title="KEMBALIKAN BERKAS"
                                                    data-reject-text="Pengajuan verifikasi <b class='text-danger'>__RESERVATION__</b> tidak sesuai"
                                                    data-reject-helper="Berikan catatan pengembalian agar pemohon dapat mengunggah ulang berkas"
                                                    data-reject-input-label="Catatan Pengembalian"
                                                    data-reject-placeholder="Berikan catatan pengembalian"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden admin-reservation-detail-modal-content">
            <div class="modal-header border-0 admin-reservation-detail-modal-header">
                <div>
                    <h5 class="modal-title text-light fw-bold mb-1" id="adminReservationDetailModalLabel"><b>DETAIL PROSES VERIFIKASI</b></h5>
