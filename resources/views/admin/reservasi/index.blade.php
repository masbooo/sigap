    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Permohonan Reservasi</h4>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <div>
                    <h5 class="fw-semibold mb-1"><b>ANTREAN PERMOHONAN RESERVASI</b></h5>
                    <p class="text-muted mb-0">
                        @if (($roleContext['scope_type'] ?? 'all') === 'all')
                            Data ini memuat seluruh permohonan reservasi yang telah diajukan di sistem
                        @else
                            Menampilkan informasi terkait antrean pengajuan reservasi di {{ $scopeLabel }}
                        @endif
                    </p>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($normalizeReservations as $index => $reservation)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-0 admin-table-action-cell">
                                        <div class="admin-table-action-dropdown">
                                            ...
                                            <div class="admin-table-action-menu" hidden>
                                                ...
                                                <form
                                                    ...
                                                    data-approve-title="KERJASAMA UMKM"
                                                    data-approve-text="Pengajuan reservasi <b class='text-danger'>{{ $requestCode }}</b> telah sesuai persyaratan awal<br><br>Lanjut ke tahap Kerjasama UMKM?"
                                                    data-approve-confirm="LANJUT"
                                                >
                                                    {!! csrf_field() !!}
                                                    ...
                                                    <button type="submit" class="admin-table-action-item">
                                                        ...
                                                        <span class="admin-table-action-label">Lanjut</span>
                                                    </button>
                                                </form>
                                                ...
                                                <form
                                                    ...
                                                    data-reservation-label="{{ $requestCode }}"
                                                    data-reject-title="KEMBALIKAN RESERVASI"
                                                    data-reject-text="Pengajuan reservasi <b class='text-danger'>__RESERVATION__</b> akan dikembalikan"
                                                    data-reject-helper="Berikan catatan pengembalian untuk pemohon"
                                                ...
                                                <form
                                                    ...
                                                    class="admin-table-action-form js-admin-reservation-reject-form"
                                                    data-reservation-label="{{ $requestCode }}"
                                                    data-reject-title="PERMOHONAN DITOLAK"
                                                    data-reject-text="Pengajuan reservasi <b class='text-danger'>__RESERVATION__</b> akan ditolak"
                                                    data-reject-helper="Berikan catatan penolakan untuk pemohon"
                                                    data-reject-input-label="Catatan Penolakan"
                                                    data-reject-placeholder="Ketik disini alasan penolakannya..."
                                                    data-reject-required-message="Catatan penolakan wajib diisi"
                                                    data-reject-fallback-prompt="Tuliskan catatan penolakan untuk __RESERVATION__:"
                                                    data-reject-confirm="TOLAK"
                                                    data-reject-confirm-text="Lanjutkan penolakan untuk __RESERVATION__?"
                                                >
                                                    {!! csrf_field() !!}
                                                    <input type="hidden" name="reservation_id" value="{{ $reservation['id'] }}">
                                                    <input type="hidden" name="rejection_note" value="">
                                                    <button type="submit" class="admin-table-action-item">
                                                        ...
                                                        <span class="admin-table-action-label">Tolak</span>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden admin-reservation-detail-modal-content">
            <div class="modal-header border-0 admin-reservation-detail-modal-header">
                <div>
                    <h5 class="modal-title text-light fw-bold mb-1" id="adminReservationDetailModalLabel"><b>DETAIL PENGAJUAN RESERVASI</b></h5>
