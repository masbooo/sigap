    ...
    <aside class="left-sidebar with-vertical">
        <div>
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="{{ url('user/dasbor') }}" class="text-nowrap logo-img">
                    <img src="{{ asset('assets/custom/images/logos/logotxt_sigap_b.svg') }}" class="dark-logo sigap-logo-text" alt="Logo-Dark" />
                    <img src="{{ asset('assets/custom/images/logos/logotxt_sigap_w.svg') }}" class="light-logo" alt="Logo-light" />
                </a>
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link ajax-link" href="{{ url('user/dasbor') }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link ajax-link" href="{{ url('user/reservasi') }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link ajax-link" href="{{ url('user/rating') }}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link ajax-link" href="{{ url('user/profil') }}">
