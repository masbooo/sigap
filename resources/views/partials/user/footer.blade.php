...
<script src="{{ asset('assets/custom/js/theme/sidebarmenu.js') }}"></script>
<script src="{{ asset('assets/custom/js/theme/app.min.js') }}"></script>

<!-- APPS -->
<script src="{{ asset('assets/custom/js/apps/calendar-init.js') }}"></script>
...
<!-- DATATABLES -->
<script src="{{ asset('assets/custom/libs/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('assets/custom/libs/datatables.net-bs5/js/dataTables.bootstrap5.min.js') }}"></script>

<!-- JAVASCRIPT -->
<script src="{{ asset('assets/main/js/ajax.js') }}"></script>
<script src="{{ asset('assets/main/js/user.js') }}"></script>
<script src="{{ asset('assets/main/js/profil-user.js') }}"></script>

<!-- ICONS -->
<script src="https://cdn.jsdelivr.net/npm/iconify-icon@1.0.8/dist/iconify-icon.min.js"></script>

<!-- DROPZONE -->
<script src="{{ asset('assets/custom/libs/dropzone/dist/min/dropzone.min.js') }}"></script>

<!-- MAGNIFIC POPUP -->
<script src="{{ asset('assets/custom/libs/magnific-popup/dist/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('assets/custom/js/plugins/meg.init.js') }}"></script>
