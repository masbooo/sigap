    ...
    <nav class="navbar navbar-expand-lg bg-primary-subtle py-2 py-lg-10">
        <div class="landing-shell d-flex align-items-center justify-content-between w-100">
            ...
            <a href="{{ base_url('') }}" class="text-nowrap logo-img">
                <img
                    src="{{ asset_url('assets/custom/images/logos/logotxt_sigap_b.svg') }}"
                    class="dark-logo"
                ...
                />
                <img
                    src="{{ asset_url('assets/custom/images/logos/logotxt_sigap_w.svg') }}"
                    class="light-logo"
            ...
            <div class="collapse navbar-collapse d-none d-lg-flex" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 gap-xl-7 gap-8 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link landing-navbar-link fs-4 fw-bold text-dark link-primary" href="{{ base_url('') }}">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link landing-navbar-link fs-4 fw-bold text-dark link-primary" href="{{ base_url('gedung') }}">Gedung</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link landing-navbar-link fs-4 fw-bold text-dark link-primary" href="{{ base_url('umkm') }}">UMKM</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link landing-navbar-link fs-4 fw-bold text-dark link-primary" href="{{ base_url('jadwal') }}">Jadwal</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="landing-login-wrap">
                    <a href="{{ base_url('login') }}" data-no-pjax class="btn btn-primary py-8 px-9">MASUK</a>
                </div>
            </div>
        </div>
    </nav>
...
<div class="offcanvas offcanvas-end landing-offcanvas" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body landing-offcanvas-body px-4 pb-4 mt-4">
        <ul class="list-unstyled ps-0 mb-0 landing-offcanvas-menu">
            <li class="mb-2">
                <a class="landing-navbar-link fs-4 d-block w-100 py-2 text-dark link-primary" href="{{ base_url('') }}">Beranda</a>
            </li>
            <li class="mb-2">
                <a class="landing-navbar-link fs-4 d-block w-100 py-2 text-dark link-primary" href="{{ base_url('gedung') }}">Gedung</a>
            </li>
            <li class="mb-2">
                <a class="landing-navbar-link fs-4 d-block w-100 py-2 text-dark link-primary" href="{{ base_url('umkm') }}">UMKM</a>
            </li>
            <li class="mb-2">
                <a class="landing-navbar-link fs-4 d-block w-100 py-2 text-dark link-primary" href="{{ base_url('jadwal') }}">Jadwal</a>
            </li>
            <li class="mb-2">
